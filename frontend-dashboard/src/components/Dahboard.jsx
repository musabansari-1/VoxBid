...
// // // //   // Sort products by time remaining (soonest to expire first)
...
// // // //           <h1 className="text-4xl md:text-5xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-amber-300 to-pink-400">
...
// // // //               <div className="rounded-full bg-purple-700 h-12 w-12"></div>
// // // //             </div>
// // // //           </div>
// // // //         ) : (
...
// // // //                           ₹{product.highest_bid.toLocaleString()}
// // // //                         </span>
// // // //                       </div>
...
// // //       fetchProducts(); // Refresh products when an auction ends
// // //     });
